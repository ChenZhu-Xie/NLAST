...
def PRL_AST__NLA__AST(U1_txt_name = "", 
    ...
    # AST(file_full_name, is_Gauss, is_OAM, is_H_l, l, phase_only, is_H_theta, theta_x, theta_y, U1_0_NonZero_size, w0, z0_AST, X, Y, lam1, is_air_pump, 1, T, save, dpi)
...
# PRL_AST__NLA__AST(file_full_name = "grating.png", border_percentage = 0.3, is_LG = 0, is_Gauss = 1, is_OAM = 1, is_H_l = 0, l = 0, p = 0, phase_only = 0, is_H_theta = 0, theta_x = 1, theta_y = 0, U1_0_NonZero_size = 0.5, w0 = 0.3, z0_NLA = 0.5, z0_AST = 1, X = 0, Y = 0, lam1 = 1.5, is_air_pump = 0, is_air = 0, T = 25, deff = 30, Tx = 20.155, Ty = 10, Tz = 17.5, mx = -1, my = 0, mz = 1, is_linear_convolution = 0, save = 0, dpi = 100)
