...
def AST(U1_name="",
    ...
    print("AST - U" + ((U1_name.find("U2") + 1) and "2" or "1") + "_{}mm.total_energy = {}".format(z0, np.sum(
        U1_z0_amp ** 2)))
    ...
    U1_z0_full_name = "6. AST - U" + ((U1_name.find("U2") + 1) and "2" or "1") + "_" + str(
        float('%.2g' % z0)) + "mm" + (is_save_txt and ".txt" or ".mat")
    if is_save == 1:
        ...
        U1_z0_amp_address = location + "\\" + "6.1. AST - " + "U" + (
                    (U1_name.find("U2") + 1) and "2" or "1") + "_" + str(
            float('%.2g' % z0)) + "mm" + "_amp" + img_name_extension
        ...
        U1_z0_phase_address = location + "\\" + "6.2. AST - " + "U" + (
                    (U1_name.find("U2") + 1) and "2" or "1") + "_" + str(
            float('%.2g' % z0)) + "mm" + "_phase" + img_name_extension
