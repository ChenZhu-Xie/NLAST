...
from C1z_chi2_3D_ssi import chi2_3D_ssi
from a1_AST import AST
from C1_SFG_ssi import SFG_ssi
...
def consistency_SHG_ssi__AST(img_full_name="Grating.png",
    ...
    chi2_3D_ssi(U_name_Structure,
                ...
                # %%
                g1=g_shift, g2=g_shift, L0_Crystal=max(z1, z2),
    ...
    U2_z2, G2_z2, ray2_z2, method_and_way2_z2, U_key2_z2 = \
        SFG_ssi(*args_ssi(z2), **kwargs_ssi, )
    ...
    U2_z1, G2_z1, ray2_z1, method_and_way2_z1, U_key2_z1 = \
        SFG_ssi(*args_ssi(z1), **kwargs_ssi, )
