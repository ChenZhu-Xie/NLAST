...
from B1z_n1_3D_ssi import n1_3D_ssi
from B1x_SCA_NLA_ssi import SCA_NLA_ssi

np.seterr(divide='ignore', invalid='ignore')


def SCA_ssi(U_name_Structure="",
    ...
    return SCA_NLA_ssi(*args_SCA_ssi, **kwargs_ssi, )
