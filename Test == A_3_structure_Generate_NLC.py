...
border_width, img_squared_resize_full_name, img_squared_resize = img_squared_Resize(img_name, img_name_extension,
                                                                                    img_squared,
                                                                                    Ix, Iy, I1_x,
                                                                                    is_print, )
...
plot_2d(I1_x, I1_y, size_PerPixel, diz,
        structure, location + "\\" + "χ2_structure" + img_name_extension, "χ2_structure",
...
plot_2d(I1_x, I1_y, size_PerPixel, diz,
        modulation_squared, location + "\\" + "χ2_modulation_squared" + img_name_extension, "χ2_modulation_squared",
        is_save, dpi, size_fig,
        cmap_2d, ticks_num, is_contourf, is_title_on, is_axes_on, is_mm, 0,
        fontsize, font,
...
if mz != 0:
    ...
    plot_2d(I1_x, I1_y, size_PerPixel, diz,
            structure_opposite, location + "\\" + "χ2_structure_opposite" + img_name_extension, "χ2_structure_opposite",
            is_save, dpi, size_fig,
            cmap_2d, ticks_num, is_contourf, is_title_on, is_axes_on, is_mm, 0,
            fontsize, font,
            0, is_colorbar_on, 0, vmax_structure, vmin_structure)
    ...
    plot_2d(I1_x, I1_y, size_PerPixel, diz,
            modulation_opposite_squared, location + "\\" + "χ2_modulation_opposite_squared" + img_name_extension,
