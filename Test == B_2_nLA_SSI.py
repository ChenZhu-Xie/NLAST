...
def H1_z_shift_k1_z(diz):
    return (np.power(math.e, k1_z_shift * diz * 1j) - 1) / k1_z_shift**2 * size_PerPixel**2 # 注意 这里的 传递函数 的 指数是 正的 ！！！
...
def Cal_G1_z_plus_dz_shift(for_th, fors_num, modulation_squared_z, *arg, ):
    ...
    G1_z_plus_dz_shift = G1_z_plus_dz_shift * H1_z_plus_dz_shift_k1_z(dizj[for_th]) + const * Q1_z_shift * H1_z_shift_k1_z(dizj[for_th])
...
def After_G1_z_plus_dz_shift_temp(for_th, fors_num, G1_z_plus_dz_shift_temp, *arg, ):
    ...
    if is_stored == 1:
        global G1_structure_frontface_shift, U1_structure_frontface, G1_structure_endface_shift, U1_structure_endface, G1_section_1_shift, U1_section_1, G1_section_2_shift, U1_section_2
...
if is_stored == 1:
    ...
    #             sheets_stored_num, U1_z_stored, z_stored, 
